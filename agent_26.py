...
def save_to_supabase(data_to_log):
    ...
    try:
        ...
        supabase_data = {
            ...
            "cpu_frequency": round(data_to_log.get("cpu_frequency", 0), 2),
            "cpu_model": data_to_log.get("cpu_model", "Unknown"),
            "processor_name": data_to_log.get("processor_name", "Unknown"),
            "cpu_cores": data_to_log.get("cpu_cores", 0),
            ...
            "total_memory_gb": round(data_to_log.get("total_memory_gb", 0), 2),
            "available_memory_gb": round(data_to_log.get("available_memory_gb", 0), 2),
            "disk_partitions_info": data_to_log.get("disk_partitions_info", []),
            "disk_read_kb": int(data_to_log["disk_read_kb"]),
            "disk_write_kb": int(data_to_log["disk_write_kb"]),
            "disk_total_gb": round(data_to_log.get("disk_total_gb", 0), 2),
            "disk_free_gb": round(data_to_log.get("disk_free_gb", 0), 2),
            "disk_type": data_to_log.get("disk_type", "Unknown"),
            "gpu_usage": int(data_to_log.get("gpu_usage", 0)),
            "gpu_model": data_to_log.get("gpu_model", "Unknown"),
            ...
            "network_speed_kbps": int(data_to_log.get("network_speed_kbps", 0)),
            "network_type": data_to_log.get("network_type", "Unknown"),
